...
export default function BeneficiaryServicesTable(props) {
    ...
    return(
        ...
        <tbody>
            ...
            <button type="button" class="btn btn-primary" onClick={() => openNewEvalutaionPage(props.user.mrn, "Counselling_Education")}>New Evaluation</button></td>
            </tr>
            <tr>
            ...
            <button type="button" class="btn btn-primary" onClick={() => openNewEvalutaionPage(props.user.mrn, "Training")}>New Evaluation</button></td>
            </tr>
        </tbody>
        </table>
    )
