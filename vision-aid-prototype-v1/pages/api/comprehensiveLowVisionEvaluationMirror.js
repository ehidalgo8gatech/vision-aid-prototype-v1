...
async function addData(req, res) {
    const body = req.body;
    let comprehensiveLowVisionEvaluationMirror = await readComprehensiveLowVisionEvaluationMirror(await prisma.hospital.findFirst({
        where: {
    ...
    try {
        const comprehensive_low_vision_evaluation_mirror = await prisma.comprehensive_Low_Vision_Evaluation_Mirror.update(update)
